...
! function(t) {
    ...
    var E, _ = "resize.webflow orientationchange.webflow load.webflow";
    ...
    i.resize = k(u, _), i.scroll = k(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = k(), i.location = function(t) {
        window.location = t
        ...
        t = t || {}, p = !0, u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), d.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), o = [], a = [], "pending" === E.state() && A()
    ...
    window.tram = function(t) {
        ...
        var N = e.frame = function() {
            ...
            F = l(function(e) {
                function n() {
                    ...
                    if (r)
                        for (N(n), e = z(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: d.ease[1],
                    from: 0,
                ...
                e.init = function(t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = z()), this.active = !0, t = this, 1 === u.push(t) && N(n))
                }, e.stop = function() {
                    var e, n, i;
        ...
        I.transform && (K.transform = [q], Y = {
            ...
            skewX: [E],
            skewY: [E]
        }), I.transform && I.backface && (Y.z = [x, "translateZ"], Y.rotateZ = [E], Y.scaleZ = [g], Y.perspective = [y]);
        var Q = /ms/,
            V = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    i.define("scroll", t.exports = function(t) {
        ...
        function w(e) {
            ...
            if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                var c, d = (c = a, p.test(c.hash) && c.host + c.pathname === n.host + n.pathname ? a.hash : "");
                if ("" !== d) {
                    var f = t(d);
    ...
    i.define("dropdown", t.exports = function(t, e) {
        ...
        function L(e, r) {
            ...
            n && l.el.on(O, function(t) {
                return function(e, n) {
                    n = n || {}, T(t), !0 === n.open && I(t), !1 === n.open && S(t, {
                        immediate: !0
                    })
                }
            }(l)), n || (d && (l.hovering = !1, S(l)), l.config.hover && l.toggle.on(y, function(t) {
                return function() {
                    t.hovering = !0, I(t)
                }
            }(l)), l.el.on(k, m), l.el.on(b, function(t) {
                return function(e) {
            ...
            }(l)), l.nav = l.el.closest(".w-nav"), l.nav.on(k, m))
        }
        ...
        function I(e) {
            if (!e.open) {
                ...
                var r = i.env("editor");
                n || A.on(_, e.mouseUpOutside), e.hovering && !r && e.el.on(E, e.mouseLeave), e.hovering && r && A.on(x, e.mouseMoveOutside), window.clearTimeout(e.delayId)
            }
        }
        ...
        function S(t) {
            ...
            if (t.open && (!t.config.hover || !t.hovering || i)) {
                ...
                var r = t.config;
                if (m.outro(0, t.el[0]), A.off(_, t.mouseUpOutside), A.off(x, t.mouseMoveOutside), t.el.off(E, t.mouseLeave), window.clearTimeout(t.delayId), !r.delay || n) return t.complete();
    ...
    i.define("navbar", t.exports = function(t, e) {
        ...
        function A(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), T(a), s ? (L(a), a.el.on("setting" + m, function(t) {
                return function(n, i) {
                    i = i || {};
                    var r = d.width();
            ...
            }(a), a.button.on("click" + m, S(a)), a.menu.on("click" + m, "a", P(a)), a.button.on("keydown" + m, function(t) {
                return function(e) {
                    switch (e.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
        ...
        function $(t, e) {
            if (!t.open) {
                t.open = !0, t.menu.each(M), t.links.addClass(x), t.dropdowns.addClass(g), t.dropdownToggle.addClass(b), t.dropdownList.addClass(y), t.button.addClass(w);
                var n = t.config;
                ...
                var r = j(t),
                    ...
                    u = t.el.height(),
                    c = t.el[0];
                if (z(0, c), E.intro(0, c), i.redraw.up(), s || f.on("click" + m, t.outside), e) p();
                else {
        ...
        function q(t, e) {
            if (t.open) {
                ...
                var n = t.config;
                if (("none" === n.animation || !l.support.transform || n.duration <= 0) && (e = !0), E.outro(0, t.el[0]), f.off("click" + m, t.outside), e) return l(t.menu).stop(), void u();
            ...
            function u() {
                t.menu.height(""), l(t.menu).set({
                    x: 0,
                    y: 0
                }), t.menu.each(W), t.links.removeClass(x), t.dropdowns.removeClass(g), t.dropdownToggle.removeClass(b), t.dropdownList.removeClass(y), t.overlay && t.overlay.children().length && (_.length ? t.menu.insertAfter(_) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close"), t.button.attr("aria-expanded", "false")
            }
        }
        return c
    })
