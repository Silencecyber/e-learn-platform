...
Webflow.require('ix2').init({
    "events": {
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".combine-faq1_question-2",
                "originalId": "6347c2441fb34299acfdf2d9|f3e8fb86-0f31-c422-7473-c92bd02979e3",
                "appliesTo": "CLASS"
            },
            "targets": [{
        ...
        "e-7": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".combine-faq1_question-3",
                "originalId": "6347c2441fb34299acfdf2d9|f3e8fb86-0f31-c422-7473-c92bd02979e3",
                "appliesTo": "CLASS"
            },
            "targets": [{
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".combine-faq1_expander-2",
                            "selectorGuids": ["799abd69-bc0a-6a36-b6ff-6103cceb5e77"]
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".combine-faq1_answer-2",
                            "selectorGuids": ["799abd69-bc0a-6a36-b6ff-6103cceb5e73"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "px",
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".combine-faq1_expander-3",
                            "selectorGuids": ["fdeebdf9-e56d-f8be-10ea-7e04aa1298de"]
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "SIBLINGS",
                            "selector": ".combine-faq1_answer-3",
                            "selectorGuids": ["fdeebdf9-e56d-f8be-10ea-7e04aa1298da"]
                        },
                        "heightValue": 0,
                        "widthUnit": "PX",
                        "heightUnit": "px",
